    ...
    return (
        ...
        <div className='w-full min-h-screen  bg-white'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-9 ">
                ...
                <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-red-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 rounded-lg focus:ring-green-200 rounded-lg text-center mr-2 mb-2 ml-8"
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-orange-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                        onClick={IrAlmacen}>
                        <svg width="50%" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-amber-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-lime-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2 ml-8"
                        onClick={IrPersonal}>
                        <svg width="50%" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-yellow-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-green-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-emerald-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2 ml-8"
                        onClick={IrComprador}>
                        <svg width="50%" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"></path>
                        </svg>
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-teal-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                ...
                {(valorRol == "Administrador") && <div>
                    <button type="button" className="flex flex-col items-center text-calc(4vw + 16px) font-bold bg-sky-300 hover:bg-gradient-to-bl hover:ring-8 focus:ring-4 focus:ring-green-200 rounded-lg text-center mr-2 mb-2"
                        onClick={IrReportes}>
                        <svg width="50%" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
